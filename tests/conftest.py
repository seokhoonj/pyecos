"""Shared test fixtures for pyecos."""

from __future__ import annotations

import pytest

from pyecos import _config
...
def _reset_credbox_binding(monkeypatch):
    ...
    monkeypatch.delenv("PYECOS_STORE_APP", raising=False)
    monkeypatch.delenv("PYECOS_NAMESPACE", raising=False)
